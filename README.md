...
Currently, this repository contains solutions to **28** LeetCode problems, covering a range of difficulty levels and algorithmic topics.

| Total | Easy | Medium | Hard |
|:-----:|:----:|:------:|:----:|
| 28 | 7 | 19 | 2 |

The pie chart below shows the distribution of problems by difficulty level, while the bar chart highlights the top 10 most frequently encountered tags. The majority of problems fall into the **Medium** category, with a focus on fundamental topics like Array, Hash Table, String.
